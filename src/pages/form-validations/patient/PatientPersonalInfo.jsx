                      ...
                      <div className="bg-gray-200 px-4 py-3 sm:px-6">
                        <div className="text-right">
                          <button
                            onClick={nextStep}
                            type="submit"
                            className="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-md font-bold text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                          >
                            Finish
                          </button>
                        </div>
